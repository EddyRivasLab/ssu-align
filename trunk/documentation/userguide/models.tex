...
the \prog{models/} subdirectory as: \\ \prog{archaea-0p1.stk},
...
\user{ssu-draw -a models/archaea-0p1.stk}

\user{ssu-draw -a models/bacteria-0p1.stk}

\user{ssu-draw -a models/eukarya-0p1.stk}
