...
\user{my30.ssu-align.sh \footnote{If this command fails, you're
    probably not using the BASH shell or the \prog{ssu-prep} was
    unable to make the file executable. In the former case, rerun the \prog{ssu-prep}
    command above with the \prog{--no-bash} option and try again. In
    the latter, execute \prog{bash my30.ssu-align.sh}}}
