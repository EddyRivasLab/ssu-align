...
\prog{models/bacteria-0p1.fa} through the RDP-CLASSIFIER tool
...
%\prog{ssu-align-0.1.1/tutorial/} directory. All seven are listed in the
...
\prog{ssu-align-0.1.1/tutorial/} to do this. The \prog{firm-7.list} file
...
\user{ssu-mask -a --seq-k firm-6.list --key-out firm-6 ../models/bacteria-0p1.stk}

\user{ssu-mask -a --seq-r firm-7.list --key-out nonfirm-86 ../models/bacteria-0p1.stk}
...
from the default seed in \prog{../models/bacterial-0p1.stk}, none of
...
\user{cat ../models/archaea-0p1.cm ../models/eukarya-0p1.cm >> my.cm}
